<?php
    ...
    if($verificar != null ){
        echo "
            ...
            <form action='./planos.php' method='POST' enctype='multipart/form-data'>
            <fieldset>
                <label for='nombre'>
                    Nombre
            ...
            ";
            echo "<form action='./planos.php' method='POST'>
                <input type='hidden' value='$usuario' name='usuario'>
                <button type='submit'>
                    Cargar
                </button>
            ...
            if(isset($_FILES['archivo']))
            {
                ...
                rename($arch,"../../statics/img/Casitas/$nombre.$ext");
                //echo $ext;
            }
            else
            {
                $carpeta=opendir("../../statics/img/Casitas/");
                $archivos=[];
                $hay_archivos=true;
                $i=0;
                ...
                if($i>=0)
                {
                    ...
                    foreach($archivos as  $llave => $value)
                    {
                        if($value!="." && $value!="..")
                        {
                            echo "<img src='../../statics/img/Casitas/$value'/>";
                        }   
                    }
                }
                else
